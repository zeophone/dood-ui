const StemsBranch = require('./stemsBranch.js');
const calendar = {
    ...
    solar2lunar:function (y,m,d,h) { //参数区间1900.1.31~2100.12.31
        ...
        return {'lYear':year,'lMonth':month,'lDay':day,'lHour':lHour,'Animal':this.getAnimal(year),'IMonthCn':(isLeap?"\u95f0":'')+this.toChinaMonth(month),'IDayCn':this.toChinaDay(day),'cYear':y,'cMonth':m,'cDay':d,'gzYear':gzY,'gzMonth':gzM,'gzDay':gzD,'isToday':isToday,'gzHour':hSection,'isLeap':isLeap,'nWeek':nWeek,'ncWeek':"\u661f\u671f"+cWeek,'isTerm':isTerm,'Term':Term,'astro':astro,'wuxing':wuxing,'bazi':bazi};
    },
